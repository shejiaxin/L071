	...
	if(ConfigModuleNoBlockCnt>CompareValue && ConfigModuleNoBlockFlage==0)
	{
		...
		switch(ConfigModuleNoBlockCaseValue)
		{
			...
			case 4:
				...
				break;
			case 5:
				SendConfigFunction("AT+QCCID\r\n",NULL,"OK",NULL,FunctionParseCompare,CompareValue);
				break;			
			case 6:
				SendConfigFunction("AT+CGATT?\r\n",NULL,"+CGATT: 1",NULL,FunctionParseCompare,CompareValue);
				break;
			case 7:
				SendConfigFunction("AT+CREG?\r\n",NULL,"0,1",NULL,FunctionParseCompare,CompareValue);
				break;
			case 8:
				SendConfigFunction("AT+QLTS=2\r\n",NULL,"OK",NULL,FunctionParseCompare,CompareValue);
				break;
			case 9:
			...
			case 14:
				...
				SendConfigFunction(main_buff,NULL,"+QMTSUB: 0,1,0,0",NULL,FunctionParseCompare,CompareValue);
				break;		
			case 15:
					...
					memset(main_buff,0,sizeof(main_buff));
					sprintf(main_buff," AT+QMTPUBEX=0,0,0,0,\"%s\",%d\r\n",Mqtt_params.Sub_Topics,main_len);
					SendConfigFunction(main_buff,NULL,">",NULL,FunctionParseCompare,CompareValue);
				break;
			case 16:	
				SendConfigFunction(main_buff1,NULL,"+QMTPUBEX: 0,0,0",NULL,FunctionParseCompare,CompareValue);
				EC800_State = 1;
				break;				
			default: 
