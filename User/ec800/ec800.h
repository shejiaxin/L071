...
typedef struct
{
	...
	uint8_t Pressure_Range; //压力变送器量程    0:0-300kpa   1:0-600kpa    2:0-1Mpa
	/*-------------------------------------*/
...
extern char main_buff[main_buff_len];
