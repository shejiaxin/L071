...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PB0     ------> ADC_IN8
    */
    GPIO_InitStruct.Pin = ALPS_2T_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(ALPS_2T_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = ALPS_4T_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(ALPS_4T_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB0     ------> ADC_IN8
    */
    HAL_GPIO_DeInit(ALPS_2T_GPIO_Port, ALPS_2T_Pin);

    HAL_GPIO_DeInit(ALPS_4T_GPIO_Port, ALPS_4T_Pin);
